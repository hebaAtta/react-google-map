...
1-after creat-react-app clone to map and install google-maps-react package
2-import package to my project
3-render the map and detect the center of it ,
from Foursquare website i get array of locations for cafe on Alexandria ,
after that add markers for those locations
4-add locations to sidebar and Can search on those locations
search filter the location on map and show the place That searched on it Only
5-when click the markers that bind an InfoWindow and changed its color to green
## Table of Contents
